...
public class BackupList extends BaseAdapter {

    private List<Backup> original_items = new ArrayList<>();
    private List<Backup> filtered_items = new ArrayList<>();
    private Context contex;
    private ItemFilter mFilter = new ItemFilter();

    private LayoutInflater l_Inflater;

    public BackupList(Context context, List<Backup> items) {
        this.contex = context;
    ...
    public List<Backup> getSelected() {
        List<Backup> selected_item = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Backup item = filtered_items.get(position);
        ViewHolder holder;
        if (convertView == null) {
            convertView = l_Inflater.inflate(R.layout.list_backup, null);
        ...
        holder.txt_version.setText("버전 : " + item.getVersion_name());
    ...
    private class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final List<Backup> list = original_items;
            final List<Backup> result_list = new ArrayList<>(list.size());
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            filtered_items = (List<Backup>) results.values;
            notifyDataSetChanged();
        }
    }
